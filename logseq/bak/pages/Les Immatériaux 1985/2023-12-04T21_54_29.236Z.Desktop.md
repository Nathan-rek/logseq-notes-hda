...
- Architecture plane
	...
	- [[Kazimir Malevitch]] : Architectones
		- Des modèles en trois dimensions réaliser au début des années. Recherches théorique cherchant a faire évoluer le [[Suprématisme (art)]] de la peinture jugée dépassée, à l’architecture, elles sont destinées à servir d’objet d’études pour les jeunes générations d’architectes
